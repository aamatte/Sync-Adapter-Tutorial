...
\end{lstlisting}
	...
	\item Query: utilizado para hacer consultas. Si no se quiere filtrar y solo obtener toda la información de la tabla se pueden dejar todos los valores como null excepto el nombre de la tabla. Para seleccionar todos los estudiantes:
...
\end{lstlisting}
	...
	\item Delete: borra datos de la base de datos.
	\item Update: actualiza datos.	
